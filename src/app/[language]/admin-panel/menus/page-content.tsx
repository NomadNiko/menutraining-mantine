// src/app/[language]/admin-panel/menus/page-content.tsx
"use client";
...
function MenusPage() {
  const { t } = useTranslation("admin-panel-menus");
  ...
  const handleSelectRestaurant = (restaurant: Restaurant) => {
    ...
    // Navigate to the restaurant/menus page
      ...
      <Container size={isMobile ? "100%" : "lg"}>
        ...
        <Text mb="xl">
          {t(
            ...
            "Select a restaurant to manage its menus. You'll be redirected to the menus page for the selected restaurant."
          )}
        </Text>
        {/* Search input */}
        <TextInput
