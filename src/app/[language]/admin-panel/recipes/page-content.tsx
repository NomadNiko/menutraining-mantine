// src/app/[language]/admin-panel/recipes/page-content.tsx
"use client";
...
function RecipesPage() {
  const { t } = useTranslation("admin-panel-recipes");
  ...
  const handleSelectRestaurant = (restaurant: Restaurant) => {
    ...
    // Navigate to the restaurant/recipes page
  ...
  return (
    <RouteGuard roles={[RoleEnum.ADMIN]}>
      <Container size={isMobile ? "100%" : "lg"}>
        ...
        <Text mb="xl">{t("selectRestaurantInstruction")}</Text>
