...
function IngredientsPage() {
  ...
  const handleSelectRestaurant = (restaurant: Restaurant) => {
    ...
    // Navigate to the restaurant/ingredients page
      ...
      <Container size={isMobile ? "100%" : "lg"}>
        ...
        <Text mb="xl">
          {t(
            ...
            "Select a restaurant to manage its ingredients. You'll be redirected to the ingredients page for the selected restaurant."
          )}
        </Text>
              ...
              >
                ...
                <Group justify="flex-end" mt="md">
                  <Button
                    ...
                    size="compact-sm"
                  >
                    {t("manageIngredients", "Manage Ingredients")}
                  </Button>
                </Group>
              </Card>
            ))}
