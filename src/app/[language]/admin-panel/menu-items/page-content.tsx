...
function MenuItemsPage() {
  ...
  const handleSelectRestaurant = (restaurant: Restaurant) => {
    ...
    // Navigate to the restaurant/menu-items page
      ...
      <Container size={isMobile ? "100%" : "lg"}>
        ...
        <Text mb="xl">
          {t(
            ...
            "Select a restaurant to manage its menu items. You'll be redirected to the menu items page for the selected restaurant."
          )}
        </Text>
        {/* Search input */}
        <TextInput
              ...
              >
                ...
                <Group justify="flex-end" mt="md">
                  <Button
                    ...
                    size="compact-sm"
                  >
                    {t("manageMenuItems", "Manage Menu Items")}
                  </Button>
                </Group>
              </Card>
            ))}
